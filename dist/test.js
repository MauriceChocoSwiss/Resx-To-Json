...
(0, index_1.convertResx)(['./test/P3JS.en.resx', './test/P3JS.resx'], 'resOut', { defaultResxCulture: 'de', mergeCulturesToSingleFile: true, generateTypeScriptResourceManager: true, searchRecursive: true });
